    ...
    <div className={styles['container']}>
      ...
      <section className={styles['container12']}>
        <div className={styles['container13']}>
          ...
          >
            <span className={styles['text24']}>From nothing to something</span>
          </h1>
        ...
        <div className={styles['container14']}>
          <div className={styles['container15']}>
            ...
            />
            <span className={` ${styles['text27']} ${projectStyles['small']} `}>
              ...
              <br></br>
              <span className={styles['text30']}>-NOAA</span>
            </span>
        ...
        <div className={styles['container19']}>
          <div className={styles['container20']}>
            <div className={styles['container21']}>
              <h2
                className={` ${styles['text41']} ${projectStyles['headingOne']} `}
              >
                Work with us
              </h2>
              <p className={` ${styles['text42']} ${projectStyles['lead']} `}>
                <span className={styles['text43']}>
                  Whatever your qualification is - we got you!
                </span>
              </p>
              <p className={` ${styles['text44']} ${projectStyles['body']} `}>
              ...
              <p className={styles['text46']}>Mark Jojansen</p>
              <p className={` ${styles['text47']} ${projectStyles['small']} `}>
      ...
      <section className={styles['Contaier']}>
        <div className={styles['container37']}>
          ...
          <h2
            className={` ${styles['text48']} ${projectStyles['headingTwo']} `}
          >
            <span className={styles['text49']}>Beware The Components</span>
          </h2>
          <h3
            className={` ${styles['text50']} ${projectStyles['headingTwo']} `}
          >
            <span className={styles['text51']}>How To Handle Them</span>
            <br></br>
          </h3>
        ...
        <div className={styles['container39']}>
          <div className={styles['container40']}>
            ...
            <div className={styles['container42']}>
              ...
              <h1
                className={` ${styles['text54']} ${projectStyles['headingOne']} `}
              >
                Search and Discover!
              </h1>
        ...
        <div className={styles['container44']}>
          ...
          <div className={styles['container46']}>
            <div className={styles['container47']}></div>
            <div className={styles['container48']}>
              ...
              <h1
                className={` ${styles['text58']} ${projectStyles['headingOne']} `}
              >
                Talk and Meet!
              </h1>
